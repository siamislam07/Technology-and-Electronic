        ...
        <div className="p-24 bg-gray-200 mt-10">
            ...
            <form onSubmit={handleAddProduct}>
                ...
                <div className="md:flex gap-5 mb-5">
                    ...
                    <div className="form-control md:w-1/2 ">
                        <label className="relative mt-5">
                            <input required className="w-full px-4 py-2 text-lg outline-none border-2 border-gray-400 rounded hover:border-gray-600 duration-200 peer focus:border-indigo-600 bg-inherit" type="number" name="rating" />
